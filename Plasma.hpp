...
public:
    ...
    double getPotentialEnergy() const; // by Daniel
    void extracttotalpotentialenergy(std::string fileName, int r,double Z);
    void loadProfile(double aTemperature, double aTotalCharge, double n, double b, int numMacro);
    ...
    double extractsizeringvector();
    void extractInitialDensitybinary(std::string fileName);
